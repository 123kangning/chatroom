...
public class EnterView {
    ...
    private static void case3(ChannelHandlerContext ctx, Scanner scanner) {
    ...
    private static void case2(ChannelHandlerContext ctx, Scanner scanner) {
    ...
    private static void case1(ChannelHandlerContext ctx, Scanner scanner) {
